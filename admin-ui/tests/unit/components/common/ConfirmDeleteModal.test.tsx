...
describe("ConfirmDeleteModal", () => {
    it("should render the item name in the title", () => {
        render(
            <ConfirmDeleteModal open={true} itemName="my-realm" onConfirm={vi.fn()} onCancel={vi.fn()} />,
        );
    ...
    it("should call onCancel when cancel button is clicked", () => {
        ...
        render(
            <ConfirmDeleteModal open={true} itemName="my-realm" onConfirm={vi.fn()} onCancel={onCancel} />,
        );
    ...
    it("should not render when open is false", () => {
        render(
            <ConfirmDeleteModal open={false} itemName="my-realm" onConfirm={vi.fn()} onCancel={vi.fn()} />,
        );
