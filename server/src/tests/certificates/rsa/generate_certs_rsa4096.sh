...
# Generate RSA 4096 certificates with PKCS#8 keys
echo "Generating RSA 4096 certificates with PKCS#8 keys..."
...
openssl genpkey -algorithm RSA -pkeyopt rsa_keygen_bits:4096 -out auth.root.key.pem
...
openssl genpkey -algorithm RSA -pkeyopt rsa_keygen_bits:4096 -out auth.server.key.pem
...
openssl genpkey -algorithm RSA -pkeyopt rsa_keygen_bits:4096 -out auth.user1.key.pem
...
openssl genpkey -algorithm RSA -pkeyopt rsa_keygen_bits:4096 -out auth.user2.key.pem
...
echo "Done! Generated RSA 4096 certificates with PKCS#8 keys:"
